...
import 'package:observer/pages/addDevice/action.dart';
        ...
        child: ListView(
          children: <Widget>[
            ...
            ListView.builder(
                ...
                itemCount: state.globalState.devices.length,
                        ...
                        child: SizedBox(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                child: Text(
                                  state.globalState.devices[index].name,
                                  style: TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.w700,
                                  ),
                              ...
                              state.globalState.devices[index].isAdded
                                  ? Padding(
                                      padding: EdgeInsets.only(
                                  ...
                                  : Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () => dispatch(AddDeviceActionCreator.onAddDevice(state.globalState.devices[index].id)),
                                        child: ClipRRect(
                                          borderRadius: BorderRadius.circular(16),
                                          child: Container(
                                            color: InnerColor.backDescribe,
